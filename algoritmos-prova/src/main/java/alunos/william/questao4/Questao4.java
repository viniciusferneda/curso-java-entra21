 ...
 * 
 */
package alunos.william.questao4;
...
public class Questao4 {
	...
	public static void main(String[] args) {
		...
		int soma = ( umNumero + umNumero );//FIXME: A soma deveria ser realizada entre umNumero e outroNumero

		if ( ( soma / 10 ) == (outroNumero % 5) ) {//FIXME: Deveria ser tirado o resto da variavel umNumero
		...
		//FIXME: Deveria ser informado somente um resultado com a comparação das condições
